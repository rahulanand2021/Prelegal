...
- Name: nda.spec.ts >> NDA Creator — form interaction >> typing governing law updates the preview
...
- generic [ref=e2]:
  - generic [ref=e4]:
    ...
    - generic [ref=e10]:
      - text: Purpose
      - textbox "How Confidential Information may be used" [ref=e11]: Evaluating whether to enter into a business relationship with the other party.
    - generic [ref=e12]:
      - text: Effective Date
